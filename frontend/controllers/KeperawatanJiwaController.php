...
use frontend\models\KeperawatanJiwaSearch;
...
/**
 * KeperawatanJiwaController implements the CRUD actions for Artikel model.
 */
class KeperawatanJiwaController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new KeperawatanJiwaSearch();
