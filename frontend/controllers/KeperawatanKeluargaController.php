...
use frontend\models\KeperawatanKeluargaSearch;
...
/**
 * KeperawatanKeluargaController implements the CRUD actions for Artikel model.
 */
class KeperawatanKeluargaController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new KeperawatanKeluargaSearch();
