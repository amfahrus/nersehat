...
use frontend\models\KeperawatanAnakSearch;
...
/**
 * KeperawatanAnakController implements the CRUD actions for Artikel model.
 */
class KeperawatanAnakController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new KeperawatanAnakSearch();
