...
use frontend\models\LanjutUsiaSearch;
...
/**
 * LanjutUsiaController implements the CRUD actions for Artikel model.
 */
class LanjutUsiaController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new LanjutUsiaSearch();
