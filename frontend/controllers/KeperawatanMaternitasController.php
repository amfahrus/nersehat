...
use frontend\models\KeperawatanMaternitasSearch;
...
/**
 * KeperawatanMaternitasController implements the CRUD actions for Artikel model.
 */
class KeperawatanMaternitasController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new KeperawatanMaternitasSearch();
